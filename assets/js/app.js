 ...
 * @param {string} eventType Evenet type e.g: "click", "mouseover"
                ...
                for (const { name, lat, lon, country, state } of locations) {
                    ...
                    searchItem.innerHTML = `
                        <span class="m-icon">location_on</span>
                            ...
                            <a href="#/weather?lat=${lat}&lon${lon}" weather aria-label="${name}" class="item-link has-state" data-search-toggler></a>
                    `;
